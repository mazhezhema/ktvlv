...
**详见**：[日志子系统设计说明.md](./guides/日志子系统设计说明.md)

---

### 7. **plog** ⭐⭐⭐（可选，Windows 开发用）
...
2. ✅ **日志系统**: F133 使用 syslog（系统自带），Windows 开发阶段可使用 plog
...
- **plog**: ⭐ 2,000+ stars，单头文件（Windows 开发阶段可选）
